...
require (
	...
	golang.conradwood.net/apis/auth v1.1.3153
	golang.conradwood.net/apis/common v1.1.3153
	golang.conradwood.net/apis/deploymonkey v1.1.3071
	golang.conradwood.net/apis/postgresmgr v1.1.2643
...
require (
	...
	golang.conradwood.net/apis/goeasyops v1.1.3153 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.3153 // indirect
